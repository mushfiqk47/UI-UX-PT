...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Mail size={20} />, href: "mailto:mushfiqk47@gmail.com" },
    { icon: <Linkedin size={20} />, href: "https://www.linkedin.com/in/mushfiq-kabir-uiux/" },
    { icon: <Briefcase size={20} />, href: "https://www.behance.net/mushfiqkabir1" },
    { icon: <Instagram size={20} />, href: "https://www.instagram.com/mushfiqkabir67/" },
  ];
